...
1. When submitting a url, the recommend format is [in summary file](summary_file.sh)

- You can either assemble this manually using the tools in RAMSAFE use the tool [summary_url.sh](#summary-of-a-url)

2. When submitting for a file on your RAMSAFE drive, here is the the recommend [format](summary_file.sh)
